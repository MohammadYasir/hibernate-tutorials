package com.myasir.joinedtable;
...
import com.myasir.joinedtable.tables.Car;
import com.myasir.joinedtable.tables.Truck;
import com.myasir.joinedtable.tables.Vehicle;
...
public class App 
{
    ...
    public static void main( String[] args )
    {
        ...
        try {
			...
			vehicle1.setManufactureYear(2012);
			vehicle1.setNoOfWheels(3);
			
			Vehicle vehicle2 = new Vehicle();
			vehicle2.setManufactureYear(2013);
			vehicle2.setNoOfWheels(3);
